 ...
 */
@WebServlet("/ShowPurchaseDetailsAdmin")
public class ShowPurchaseDetailsAdmin extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowPurchaseDetailsAdmin() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// TODO Auto-generated method stub
				...
				request.getRequestDispatcher("AdminPurchaseDetails.jsp").forward(request, response);
	}
