...
/**
 * Servlet implementation class UpdateProductAdminServlet
 */
@WebServlet("/UpdateProductAdminServlet")
public class UpdateProductAdminServlet extends HttpServlet {
     ...
     */
    public UpdateProductAdminServlet() {
        super();
				...
				response.setContentType("text/html");
				 ...
				 Part part=request.getPart("product_image");
					...
					pb.setPimage(inputStream);
					 int status=ProductDao.updateProduct(pb);
					 if(status>0)
					 {
